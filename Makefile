...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/07/09 10:31:19 by mefische          #+#    #+#              #
#    Updated: 2025/07/09 10:31:19 by mefische         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES	= main.c close_window.c images.c render_map.c movements.c check_map/check_map.c check_map/parsing_map.c check_map/check_map_utils.c check_map/valid_path.c
